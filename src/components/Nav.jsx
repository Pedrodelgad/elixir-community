...
export default function Nav({ onLoginRequest }) {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-10 overflow-visible"
      style={{
        height: '64px',
              ...
              <div className="p-2">
                {user ? (
                  <>
                    ...
                    <a href="#comunidade" onClick={() => setOpen(false)} className={linkClass} style={linkStyle} onMouseEnter={e => linkHover(e, true)} onMouseLeave={e => linkHover(e, false)}>Comunidade</a>
                    <Link to="/area-do-aluno" onClick={() => setOpen(false)} className={linkClass} style={linkStyle} onMouseEnter={e => linkHover(e, true)} onMouseLeave={e => linkHover(e, false)}>Área do Aluno</Link>
                    <Link to="/planos" onClick={() => setOpen(false)} className={linkClass} style={linkStyle} onMouseEnter={e => linkHover(e, true)} onMouseLeave={e => linkHover(e, false)}>Planos</Link>
                    <Link to="/afiliado" onClick={() => setOpen(false)} className={linkClass} style={linkStyle} onMouseEnter={e => linkHover(e, true)} onMouseLeave={e => linkHover(e, false)}>Afiliados</Link>
                  ...
                  <>
                    ...
                    <Link to="/planos" onClick={() => setOpen(false)} className={linkClass} style={linkStyle} onMouseEnter={e => linkHover(e, true)} onMouseLeave={e => linkHover(e, false)}>Planos</Link>
                    <Link to="/afiliado" onClick={() => setOpen(false)} className={linkClass} style={linkStyle} onMouseEnter={e => linkHover(e, true)} onMouseLeave={e => linkHover(e, false)}>Afiliados</Link>
                    <button onClick={() => { onLoginRequest(); setOpen(false) }} className="w-full flex items-center justify-center mt-1 py-2.5 rounded-xl text-[13px] font-semibold text-white transition-all"
