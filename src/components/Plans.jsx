...
const plans = [
  ...
  },
  {
    ...
    description: 'Pague uma vez e tenha acesso Alpha completo — para sempre, sem renovar.',
...
const DISCORD_INVITE = 'https://discord.gg/elixiralpha' // servidor da comunidade (plano gratuito)
